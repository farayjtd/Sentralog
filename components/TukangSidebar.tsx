...
const MENUS = [
  { key: '/(tukang)', label: '🏠 Dashboard' },
  { key: '/(tukang)/absen', label: '📅 Absensi' },
]

export default function TukangSidebar() {
  ...
  return (
    <View style={styles.sidebar}>
      <View style={styles.profile}>
        ...
        <Text style={styles.role}>Tukang</Text>
      </View>
      {MENUS.map(menu => {
...
const styles = StyleSheet.create({
  ...
  avatar: { width: 48, height: 48, borderRadius: 24, backgroundColor: '#37474f', alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
  ...
  menuItemActive: { backgroundColor: '#f0f2f5', borderLeftColor: '#37474f' },
  menuLabel: { fontSize: 13, color: '#555' },
  menuLabelActive: { color: '#37474f', fontWeight: '600' },
